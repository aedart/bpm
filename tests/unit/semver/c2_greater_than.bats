...
setup() {
    ...
    # Debug
#    echo "Semver Compare grater than" >&3
}

@test "greater than" {
    # 0 = true, 1 = false
    local data_provider="
2.0.0             1.0.0                         0       # (a > b) major
1.1.0             1.0.0                         0       # (a > b) minor
1.2.1             1.2.0                         0       # (a > b) patch
1.2.1+abc         1.2.0+132                     0       # (a > b) build meta ignored
1.0.0             1.0.0-alpha                   0       # (a > b)
1.0.0             1.0.0-rc.1                    0       # (a > b)
1.0.0-rc.1        1.0.0-beta.11                 0       # (a > b)
1.0.0-beta.11     1.0.0-beta.2                  0       # (a > b)
1.0.0-beta.2      1.0.0-beta                    0       # (a > b)
1.0.0-beta        1.0.0-alpha.beta              0       # (a > b)
1.0.0-alpha.beta  1.0.0-alpha.1                 0       # (a > b)
1.0.0-alpha.1     1.0.0-alpha                   0       # (a > b)
1.0.0-alpha.1+123 1.0.0-alpha+abc               0       # (a > b)
...
"
    ...
    run_compare_method "semver::gt" "$data_provider"
}
...
"
    ...
    run_compare_method "semver::gte" "$data_provider"
}